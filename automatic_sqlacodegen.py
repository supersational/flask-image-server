...
class Participant(Base):
    ...
    studys = relationship(u'Study', secondary='studyparticipants')
...
t_studyparticipants = Table(
    ...
    Column('participant_id', ForeignKey(u'participants.participant_id')),
...
if __name__ == "__main__":
    ...
    engine = create_engine('postgres://postgres:testing@localhost:3145/linker', convert_unicode=True)
